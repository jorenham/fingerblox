...
public class MainActivity extends AppCompatActivity {
    ...
    protected CaptureRequest.Builder previewCaptureRequestBuilder;
        ...
        try {
            ...
            ImageReader.OnImageAvailableListener readerListener = new ImageReader.OnImageAvailableListener() {
                ...
                public void onImageAvailable(ImageReader reader) {
                    ...
                    Bitmap bitmap = imageToBitmap(image.getPlanes()[0]);
                    Log.i(TAG, String.format("Bitmap contents: %d", bitmap.describeContents()));
    ...
    private Bitmap imageToBitmap(Image.Plane plane) {
    ...
    protected void createCameraPreview() {
        try {
            ...
            final Float focus_distance = 0f;
            previewCaptureRequestBuilder.set(CaptureRequest.LENS_FOCUS_DISTANCE, 31f);
    ...
    protected void updatePreview() {
        ...
        try {
            cameraCaptureSessions.setRepeatingRequest(previewCaptureRequestBuilder.build(), null, null);
        } catch (CameraAccessException e) {
            e.printStackTrace();
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == REQUEST_CAMERA_PERMISSION && grantResults[0] == PackageManager.PERMISSION_DENIED) {
            // close the app
            Toast.makeText(MainActivity.this, "You can't use this app without camera permission", Toast.LENGTH_LONG).show();
            finish();
        }
    }
